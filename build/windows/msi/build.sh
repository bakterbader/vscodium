...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="RasterAndonConfigurator - Insiders"
  PRODUCT_CODE="RasterAndonConfiguratorInsiders"
  PRODUCT_UPGRADE_CODE="D9963823-AD1F-45C1-8395-C6CE5F040FDB"
  ICON_DIR="..\\..\\..\\src\\insider\\resources\\win32"
  SETUP_RESOURCES_DIR=".\\resources\\insider"
else
  PRODUCT_NAME="RasterAndonConfigurator"
  PRODUCT_CODE="RasterAndonConfigurator"
  PRODUCT_UPGRADE_CODE="54385D9A-9ECE-4F60-A20A-C38A92B11281"
